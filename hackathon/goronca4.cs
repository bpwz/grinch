...
namespace hackathon
{
    public partial class goronca4 : Form
    {
        private gorace_aukcje gorace_Aukcje;
        public goronca4(gorace_aukcje gorace_aukcje)
        {
            InitializeComponent();
            txtOdp.Hide();
            txtpyt.Hide();
        ...
        private void btnSprawdz_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtCena.Text, out int twojaliczba))
            {
                ...
                {
                    gorace_Aukcje.gorocaAukcja4Wygrana();
        ...
        private void goronca4_Load(object sender, EventArgs e)
        {
