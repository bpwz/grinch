...
namespace hackathon
{
    public partial class goronca3 : Form
    {
        private gorace_aukcje gorace_Aukcje;
        public goronca3(gorace_aukcje gorace_aukcje)
        {
            InitializeComponent();
            txtOdp.Hide();
            txtpyt.Hide();
        ...
        private void btnSprawdz_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtCena.Text, out int twojaliczba))
            {
                ...
                {
                    gorace_Aukcje.gorocaAukcja3Wygrana();
        ...
        private void goronca3_Load(object sender, EventArgs e)
        {
