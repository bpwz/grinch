...
namespace hackathon
{
    public partial class goronca2 : Form
    {
        private gorace_aukcje gorace_Aukcje;
        public goronca2(gorace_aukcje gorace_aukcje)
        {
            InitializeComponent();
            txtOdp.Hide();
            txtpyt.Hide();
        ...
        private void btnSprawdz_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtCena.Text, out int twojaliczba))
            {
                ...
                {
                    gorace_Aukcje.gorocaAukcja2Wygrana();
        ...
        private void goronca2_Load(object sender, EventArgs e)
        {
