...
namespace hackathon
{
    public partial class goronca7 : Form
    {
        private gorace_aukcje gorace_Aukcje;

        public goronca7(gorace_aukcje gorace_aukcje)
        {
            InitializeComponent();
            txtOdp.Hide();
            txtpyt.Hide();
        ...
        private void btnSprawdz_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtCena.Text, out int twojaliczba))
            {
                ...
                {
                    gorace_Aukcje.gorocaAukcja7Wygrana();
        ...
        private void goronca7_Load(object sender, EventArgs e)
        {
