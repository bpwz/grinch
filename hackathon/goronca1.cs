...
namespace hackathon
{
    public partial class goronca1 : Form
    {
        private gorace_aukcje gorace_Aukcje;

        public goronca1(gorace_aukcje gorace_aukcje)
        {
            InitializeComponent();
            txtOdp.Hide();
            txtpyt.Hide();
        ...
        private void btnSprawdz_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtCena.Text, out int twojaliczba))
            {
                ...
                {
                    gorace_Aukcje.gorocaAukcja1Wygrana();
                ...
                // jak wygram to ma sie hide i sie pojawic w formie zakonczone_aukcje i tak kazde od goronce 1 do 7//
        ...
        private void goronca1_Load(object sender, EventArgs e)
        {
