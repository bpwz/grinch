...
namespace hackathon
{
    public partial class goronca5 : Form
    {
        private gorace_aukcje gorace_Aukcje;
        public goronca5(gorace_aukcje gorace_aukcje)
        {
            InitializeComponent();
            txtOdp.Hide();
            txtpyt.Hide();
        ...
        private void btnSprawdz_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtCena.Text, out int twojaliczba))
            {
                ...
                {
                    gorace_Aukcje.gorocaAukcja5Wygrana();
        ...
        private void goronca5_Load(object sender, EventArgs e)
        {
