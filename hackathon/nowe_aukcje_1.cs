...
namespace hackathon
{
    public partial class nowe_aukcje_1 : Form
    {
        private nowe_aukcje nowe_Aukcje;
        public nowe_aukcje_1(nowe_aukcje nowe_aukcje)
        {
            InitializeComponent();
            txtOdp.Hide();
            txtpyt.Hide();
        ...
        private void nowe_aukcje_1_Load(object sender, EventArgs e)
        {
